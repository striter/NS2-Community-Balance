...
ModLoader.SetupFileHook("lua/CloakableMixin.lua", "lua/CNBalance/CloakableMixin.lua", "replace")
...
ModLoader.SetupFileHook("lua/Weapons/Alien/Metabolize.lua", "lua/CNBalance/Weapons/Aliens/Metabolize.lua", "replace")
