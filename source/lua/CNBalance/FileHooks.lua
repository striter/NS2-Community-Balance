ModLoader.SetupFileHook("lua/ClientUI.lua", "lua/CNBalance/ClientUI.lua", "post")
...
ModLoader.SetupFileHook("lua/AlienWeaponEffects.lua", "lua/CNBalance/AlienWeaponEffects.lua", "post" )
