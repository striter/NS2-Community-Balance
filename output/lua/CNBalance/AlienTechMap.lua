...
kAlienTechMap =
{
    ...
    {kTechId.BoneWall, 3.5, 7},         { kTechId.BioMassThree, 3.5, 8, nil, "3" },  { kTechId.MetabolizeEnergy, 3.5, 9 }, {kTechId.BileBomb, 3.5, 10},
                                        { kTechId.BioMassFour, 4.5, 8, nil, "4" }, {kTechId.Leap, 4.5, 9},{kTechId.BabblerEgg, 4.5, 10}, 
                                        { kTechId.BioMassFive, 5.5, 8, nil, "5" }, {kTechId.MetabolizeHealth, 5.5, 9},{kTechId.Spores, 5.5, 10},{kTechId.AcidRocket, 5.5, 11},
