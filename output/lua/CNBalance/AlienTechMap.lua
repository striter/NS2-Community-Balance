...
kAlienTechMap =
{
    ...
    { kTechId.ShiftHive, 3, 3 }, { kTechId.ShadeHive, 7, 3 }, { kTechId.CragHive, 11, 3 },
    
    --FIXME Update and correct all icon positions

    { kTechId.ShiftTunnel,2 , 4},{ kTechId.Spur, 3, 4, SetSpurIcon }, { kTechId.ShiftHiveBiomassPreserve,4 , 4,GetShiftHiveBiomassPreservation},
    ...
    { kTechId.CragTunnel,10 , 4},{ kTechId.Shell, 11, 4, SetShellIcon }, { kTechId.CragHiveBiomassPreserve,12 , 4,GetCragHiveBiomassPreservation},
    
    { kTechId.CystCelerity, 2, 3 }, { kTechId.CystCamouflage, 6, 3 }, { kTechId.CystCarapace, 10, 3 },
    { kTechId.DrifterCelerity, 4, 3 },  { kTechId.DrifterCamouflage, 8, 3 }, { kTechId.DrifterRegeneration, 12, 3 },

    { kTechId.Silence, 3, 6 },
    { kTechId.Crush, 2, 5 },
    { kTechId.Celerity, 3, 5 },
    { kTechId.Adrenaline, 4, 5 },
    ...
    { kTechId.Vampirism, 10, 5 },
    { kTechId.Carapace, 11, 5 },
    { kTechId.Regeneration, 12, 5 }, 
    { kTechId.Condense, 11, 6 },

                                        { kTechId.BioMassOne, 1.5, 8.5, nil, "1" }, {kTechId.ShadowStep, 1.5, 9.5},--{kTechId.Web, 1.5, 10.5},
    {kTechId.Rupture, 2.5, 7.5},          { kTechId.BioMassTwo, 2.5, 8.5, nil, "2" },  { kTechId.MetabolizeEnergy, 2.5, 9.5 }, {kTechId.BabblerEgg, 2.5, 10.5},
    {kTechId.BoneWall, 3.5, 7.5},         { kTechId.BioMassThree, 3.5, 8.5, nil, "3" }, { kTechId.BileBomb, 3.5, 9.5 },{ kTechId.Devour, 3.5, 10.5},
                                        { kTechId.BioMassFour, 4.5, 8.5, nil, "4" }, { kTechId.Leap, 4.5, 9.5}, {kTechId.Spores, 4.5, 10.5},
                                        { kTechId.BioMassFive, 5.5, 8.5, nil, "5" }, { kTechId.BoneShield, 5.5, 9.5}, { kTechId.MetabolizeHealth, 5.5, 10.5},{kTechId.AcidRocket, 5.5, 11.5},
                                        { kTechId.BioMassSix, 6.5, 8.5, nil, "6" },  { kTechId.Umbra, 6.5, 9.5},{kTechId.AcidSpray, 6.5, 10.5},
                                        { kTechId.BioMassSeven, 7.5, 8.5, nil, "7" }, { kTechId.Xenocide, 7.5, 9.5},{kTechId.Stab, 7.5, 10.5},
                                        { kTechId.BioMassEight, 8.5, 8.5, nil, "8" }, { kTechId.Stomp, 8.5, 9.5},{kTechId.VortexShadowStep, 8.5, 10.5 },
                                        { kTechId.BioMassNine, 9.5, 8.5, nil, "9" },
    {kTechId.Contamination, 10.5, 7.5},   { kTechId.BioMassTen, 10.5, 8.5, nil, "10" },  {kTechId.XenocideFuel, 10.5, 9.5},
                                        { kTechId.BioMassEleven, 11.5, 8.5, nil, "11" },
                                        { kTechId.BioMassTwelve, 12.5, 8.5, nil, "12" },
}
...
kAlienLines =
{
    ...
    { 7, 1.5, 7, 2.5 },
    { 3, 2.5, 11, 2.5},
    { 3, 2.5, 3, 3},{ 7, 2.5, 7, 3},{ 11, 2.5, 11, 3},
    ...
    GetLinePositionForTechMap(kAlienTechMap, kTechId.Shell, kTechId.Condense),
    ...
    GetLinePositionForTechMap(kAlienTechMap, kTechId.Veil, kTechId.Phantom),
