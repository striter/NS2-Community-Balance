...
kAlienTechMap =
{
    ...
    {kTechId.BoneWall, 3.5, 7},         { kTechId.BioMassThree, 3.5, 8, nil, "3" }, { kTechId.MetabolizeEnergy, 3.5, 9 },{ kTechId.BileBomb, 3.5, 10},
                                        ...
                                        { kTechId.BioMassFive, 5.5, 8, nil, "5" }, { kTechId.MetabolizeHealth, 5.5, 9}, { kTechId.AcidSpray, 5.5, 10},{kTechId.AcidRocket, 5.5, 11},
                                        { kTechId.BioMassSix, 6.5, 8, nil, "6" },  {kTechId.BoneShield, 6.5, 9},{kTechId.Umbra, 6.5, 10},
