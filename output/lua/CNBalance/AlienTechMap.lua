...
kAlienTechMap =
{
    ...
    {kTechId.BoneWall, 3.5, 7},         { kTechId.BioMassThree, 3.5, 8, nil, "3" }, { kTechId.BileBomb, 3.5, 9 },{ kTechId.Devour, 3.5, 10},
                                        { kTechId.BioMassFour, 4.5, 8, nil, "4" }, { kTechId.Leap, 4.5, 9}, {kTechId.Spores, 4.5, 10},{kTechId.AcidRocket, 4.5, 11},
                                        { kTechId.BioMassFive, 5.5, 8, nil, "5" }, { kTechId.BoneShield, 5.5, 9}, { kTechId.MetabolizeHealth, 5.5, 10},
                                        { kTechId.BioMassSix, 6.5, 8, nil, "6" },  { kTechId.Umbra, 6.5, 9},{kTechId.AcidSpray, 6.5, 10},{kTechId.VortexShadowStep, 6.5, 11},
