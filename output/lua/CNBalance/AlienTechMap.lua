...
kAlienTechMap =
{
    ...
    {kTechId.Rupture, 2.5, 7},          { kTechId.BioMassTwo, 2.5, 8, nil, "2" },  { kTechId.Devour, 2.5, 9 }, {kTechId.BabblerEgg, 2.5, 10},
    {kTechId.BoneWall, 3.5, 7},         { kTechId.BioMassThree, 3.5, 8, nil, "3" }, { kTechId.MetabolizeEnergy, 3.5, 9 },{ kTechId.BileBomb, 3.5, 10},
                                        ...
                                        { kTechId.BioMassFive, 5.5, 8, nil, "5" }, { kTechId.MetabolizeHealth, 5.5, 9}, { kTechId.BoneShield, 5.5, 10},{kTechId.AcidRocket, 5.5, 11},
                                        { kTechId.BioMassSix, 6.5, 8, nil, "6" },  {kTechId.AcidSpray, 6.5, 9},{kTechId.Umbra, 6.5, 10},
