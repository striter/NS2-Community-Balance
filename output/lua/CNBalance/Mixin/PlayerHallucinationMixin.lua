-- Merged from bishop/fixes/PlayerHallucinationMixin.lua
-- Improvements over vanilla:
-- 1. Brain senses setup with team brain during initialization
-- 2. Prevent hallucinations from sending chat messages
