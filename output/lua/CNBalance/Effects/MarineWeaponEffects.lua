local kAdditionalEffects =
{
	...
	draw =
    {
        marineWeaponDrawSounds =
        {
			...
			{player_sound = "sound/combat.fev/combat/weapons/marine/revolver/draw", classname = "Revolver", volume = 0.5, done = true},
            {player_sound = "sound/combat.fev/combat/weapons/marine/knife/deploy", classname = "Knife", done = true},
			{player_sound = "sound/combat.fev/combat/weapons/marine/lmg/draw", classname = "LightMachineGun", done = true},
   ...
   reload_speed0 = 
    {
        gunReloadEffects =
        {
			{player_sound = "sound/combat.fev/combat/weapons/marine/revolver/reload0", classname = "Revolver", done = true},
            {player_sound = "sound/combat.fev/combat/weapons/marine/heavy_cannon/reload0", classname = "Cannon", done = true},
			{player_sound = "sound/combat.fev/combat/weapons/marine/lmg/reload0", classname = "LightMachineGun", done = true},
	...
	reload_speed1 = 
    {
        gunReloadEffects =
        {
			{player_sound = "sound/combat.fev/combat/weapons/marine/revolver/reload1", classname = "Revolver", done = true},
            {player_sound = "sound/combat.fev/combat/weapons/marine/heavy_cannon/reload1", classname = "Cannon", done = true},
			{player_sound = "sound/combat.fev/combat/weapons/marine/lmg/reload1", classname = "LightMachineGun", done = true},
    ...
    reload_cancel =
    {
        ...
        {
			{stop_sound = "sound/combat.fev/combat/weapons/marine/revolver/reload0", classname = "Revolver"},
			{stop_sound = "sound/combat.fev/combat/weapons/marine/revolver/reload1", classname = "Revolver", done = true},
			...
			{stop_sound = "sound/combat.fev/combat/weapons/marine/lmg/reload0", classname = "LightMachineGun"},
			{stop_sound = "sound/combat.fev/combat/weapons/marine/lmg/reload1", classname = "LightMachineGun", done = true},
	...
	revolver_attack = 
    {
        revolverAttackEffects = 
        {
            ...
            {player_sound = "sound/combat.fev/combat/weapons/marine/revolver/fire"},
        },
    },
    ...
    knife_attack = 
    {
        knifeAttackEffects = 
        {
            { player_sound = "sound/combat.fev/combat/weapons/marine/knife/attack", sex = "female", done = true },
            { player_sound = "sound/combat.fev/combat/weapons/marine/knife/attack" },
        },
    },
}
