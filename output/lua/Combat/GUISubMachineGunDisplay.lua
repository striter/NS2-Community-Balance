...
class 'GUISubMachineGunDisplay' (GUIScript)

function GUISubMachineGunDisplay:Initialize()
...
function GUISubMachineGunDisplay:Update(deltaTime)

    PROFILE("GUISubMachineGunDisplay:Update")
...
function GUISubMachineGunDisplay:SetClip(weaponClip)
    self.weaponClip = weaponClip
end

function GUISubMachineGunDisplay:SetClipSize(weaponClipSize)
    self.weaponClipSize = weaponClipSize
end

function GUISubMachineGunDisplay:SetAmmo(weaponAmmo)
    self.weaponAmmo = weaponAmmo
end

function GUISubMachineGunDisplay:SetGlobalTime(globalTime)
    self.globalTime = globalTime
end

function GUISubMachineGunDisplay:SetLowAmmoWarning(lowAmmoWarning)
    self.lowAmmoWarning = ConditionalValue(lowAmmoWarning == "true", true, false)
end

function GUISubMachineGunDisplay:SetClipFraction(clipIndex, fraction)
...
function Initialize()
    ...
    bulletDisplay = GUISubMachineGunDisplay()
